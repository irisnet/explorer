		...
		<div class="graph_content_wrap">
			<div class="graph_content_title">
				<div>Inter-Chain Network
					<span class="beat_content" v-if="!flShowTestTooltip">Beta <el-tooltip class="tooltip_content"
					                                                                      :content="'The data displayed here are from GoZ Phase 3.'"><i
							style="font-size: 0.12rem" class="iconfont iconyiwen"></i></el-tooltip></span>
				</div>
