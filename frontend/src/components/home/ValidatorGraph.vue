								...
								<li class="graph_list_item" v-for="(item,index) in colorDataArray"
									...
									<div class="legend_block"
									     ...
									     v-if="item.name !== 'Cosmos Hub (cosmoshub-4)'
									      ...
									      && item.name !== 'Persistence (Core-1)'
									      && item.name !== 'Regen Network (regen-1)'
									      && item.name !== 'Osmosis (Osmosis-1)'
                                    ...
                                    <div class="legend_block_img" :class="item.isActive ? '' : 'img_hide_style'"  v-if="item.name === 'Persistence (Core-1)'">
                                        <img src="../../assets/logo_persistence_menu.png" alt="">
                                    </div>
                                    <div class="legend_block_img" :class="item.isActive ? '' : 'img_hide_style'"  v-if="item.name === 'Regen Network (regen-1)'">
                                        <img src="../../assets/logo_regen_menu.png" alt="">
                                    </div>
                                    <div class="legend_block_img" :class="item.isActive ? '' : 'img_hide_style'"  v-if="item.name === 'Osmosis (Osmosis-1)'">
                                        <img src="../../assets/logo_osmosis_menu.png" alt="">
                                    </div>
                                    <div class="legend_block_img" :class="item.isActive ? '' : 'img_hide_style'"  v-if="item.name === 'Sentinel (Sentinelhub-2)'">
                                        <img src="../../assets/logo_sentinelhub_menu.png" alt="">
                                    </div>
									<div class="legend_name_content">
										<p class="legend_name" :class="item.isActive ? '' : 'hide_style_color'">
											<span v-show="item.name !== 'Crypto.com (Crypto-Org-Chain-Mainnet-1)'
											 ...
											 && item.name !== 'Regen Network (regen-1)'
											 && item.name !== 'Osmosis (Osmosis-1)'
											 && item.name !== 'Sentinel (Sentinelhub-2)'">{{item.name}}</span>
                                            ...
                                            <span class="legend_name_style">
                                               <span v-show="item.name === 'Persistence (Core-1)'">Persistence</span>
											   <span class="display_ellipsis" v-show="item.name === 'Persistence (Core-1)'"> (Core-1)</span>
                                            </span>
                                            <span class="legend_name_style">
                                               <span v-show="item.name === 'Regen Network (regen-1)'">Regen Network</span>
											   <span class="display_ellipsis" v-show="item.name === 'Regen Network (regen-1)'"> (regen-1)</span>
                                            </span>
                                            <span class="legend_name_style">
                                               <span v-show="item.name === 'Osmosis (Osmosis-1)'">Osmosis</span>
											   <span class="display_ellipsis" v-show="item.name === 'Osmosis (Osmosis-1)'"> (Osmosis-1)</span>
                                            </span>
                                            <span class="legend_name_style">
                                               <span v-show="item.name === 'Sentinel (Sentinelhub-2)'">Sentinel</span>
											   <span class="display_ellipsis" v-show="item.name === 'Sentinel (Sentinelhub-2)'"> (Sentinelhub-2)</span>
                                            </span>
                                        </p>
										<p class="legend_name" :class="item.isActive ? '' : 'hide_style_color'"
		...
		methods: {
            ...
            setNodeImage(nodeName){
                switch (nodeName){
                    ...
                    case 'Persistence (Core-1)':
                        return 'image://data:image/png;base64,'
                    case 'Regen Network (regen-1)':
                        return 'image://data:image/png;base64,'
                    case 'Osmosis (Osmosis-1)':
                        return 'image://data:image/png;base64,'
                    case 'Sentinel (Sentinelhub-2)':
                        return 'image://data:image/png;base64,'
                }
            },
            formatName(nodeName){
