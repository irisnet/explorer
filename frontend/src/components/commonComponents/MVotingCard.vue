<template>
    <div class="voting_card_content">
        ...
        <div class="voting_title_container" :class="showTitle ? 'home_style': ''">
            <div>
                <span><i :style="{color:flHighlightParticipation ? 'var(--baColor)' : '#D7DCE0'}" class="iconfont iconBondedTokens"></i>Participation {{participationThreshold}}%</span>
                <span><i :style="{color:flShowPassThreshold ? 'var(--baColor)' : '#D7DCE0'}" class="iconfont iconBondedTokens"></i>Pass Threshold {{passThreshold}}%</span>
            </div>
        ...
        <div class="voting_content">
            ...
            <div class="voting_center_container">
                <div class="voting_progress_bar_content">
                    ...
                    <div class="default_progress_bar_content" :style="{background: totalVoted || delegatorVoted ? 'var(--baColor)' : ''}"></div>
