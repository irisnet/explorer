...
<template>
    <div :class="appHeaderVar" v-show="showHeader" id="header">
        <header class="app_header_person_computer" v-show="devicesShow === 1">
                ...
                <div class="header_top_content_wrap">
                    ...
                    <div class="header_menu_content">
                        <ul class="header_menu_list_content">
                            <li :class="activeClassName === '/home'?'nav_item_active':''" @click="featureButtonClick('/home')">Home</li>
                            <li :class="activeClassName === '/validators'?'nav_item_active':''" @click="featureButtonClick('/validators')">Validators</li>
                            <li :class="activeClassName === '/blocks'?'nav_item_active':''" @click="featureButtonClick('/blocks')">Blocks</li>
                            <li class="transaction_list_content"
                                ...
                                <div class="transaction_content" style="display: flex">Transactions<span class="bottom_arrow"></span></div>
                                <ul class="transaction_list_item_content" style="" v-show="showSubTransaction">
                                    <router-link :to="`/txs/transfers`"><li class="transaction_list_item">Transfers</li></router-link>
                                    <router-link :to="`/txs/declarations`"><li class="transaction_list_item" >Declarations</li></router-link>
                                    <router-link :to="`/txs/stakes`"><li class="transaction_list_item">Stakes</li></router-link>
                                    <router-link :to="`/txs/governance`"><li class="transaction_list_item">Governance</li></router-link>
                                </ul>
                            </li>
                            <li class="statics_list_content"
                                ...
                                <div class="statics_content" style="display: flex">Statistics<span class="bottom_arrow"></span></div>
                                <ul class="statics_list_item_content" style="color: #000;background: #3598db" v-show="flShowStatistics">
                                   <router-link :to="`/statistics/richlist`"><li class="static_list_item">Rich List</li></router-link>
                                </ul>
                            </li>
                            <li class="governance_list_content"
                                ...
                                <div class="governance_content" style="display: flex">Governance<span class="bottom_arrow"></span></div>
                                <ul class="governance_list_item_content" style="color: #000;background: #3598db" v-show="flShowGovernanceOption">
                                    <router-link :to="`/gov/parameters`"><li class="governance_list_item">Parameters</li></router-link>
                                    <router-link :to="`/gov/proposals`"><li class="governance_list_item">Proposals</li></router-link>
                                </ul>
                            </li>
                        ...
                        <div class="header_network_content">
                            <div class="network_list_content">
                                <div class="network_list_title_content" style="display: flex">{{currentSelected}}<span class="bottom_arrow"></span></div>
                                <ul class="network_list_item_content" style="color: #000;background: #3598db">
                            ...
                            <div class="search_content" @click="toggleShowSearchIpt()">
            ...
            <div class="search_input_container" v-show="flShowSearchIpt">
