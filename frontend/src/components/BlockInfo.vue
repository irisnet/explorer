            ...
            getBlockInformation() {
                ...
                Service.http(url).then((data) => {
                    ...
                    if (data) {
                        ...
                        this.lastBlockValue = data.block_info.last_block;
                        this.lastBlockHashValue = data.block_info.last_block_hash;
                        ...
                        this.precommitValidatorsValue = data.block_info.precommit_validators ? data.block_info.precommit_validators : '';
                        this.votingPowerValue = data.block_info.voting_power ? data.block_info.voting_power : '';
