    ...
    <div class="home_module_block_content">
      ...
      <div class="none_data_img_container" v-if="information.length === 0">
        <div class="nodata_img_container">
          ...
          <span v-show="blockModuleTypeVar !== 'blocks_background_type'">No Transaction</span>
          <span v-show="blockModuleTypeVar === 'blocks_background_type'">No Block</span>
        </div>
      </div>
    </div>
  </div>
  ...
  export default {
    ...
    data() {
      return {
        ...
        homeModuleBlockTitleVar:this.moduleName === 'Blocks'?'blocks_background':'transactions_background',
        blockModuleTypeVar:this.moduleName === 'Blocks'?'blocks_background_type':'transactions_background_type',
