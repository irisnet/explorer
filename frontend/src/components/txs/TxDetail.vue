        ...
        <div class="tx_detail_common_information_content_wrap">
                    ...
                    <li class="tx_detail_common_information_item">
                        ...
                        <div class="tx_detail_common_information_item_value" style="display: flex">
                            ...
                            <div v-if="statusValue === 'Failed'" class="log_content_container">
                                ...
                                <div class="tip_content" :class="failTipStyle ? 'overstep_style' :''"
                                     :style="{left:`${-((logContentWidth / 2) - 6) / 100}rem`}">
            ...
            <div class="tx_detail_message_information_content">
                <ul class="tx_detail_message_information">
                    <li class="tx_detail_message_information_item"
                        v-for="(item,key) in messageList">
                        <span class="tx_detail_message_information_name"
                              v-if="key !=='tooltip'">
                            {{key}}
                        </span>
                        <div>
                            <div class="tx_detail_message_information_value"
                                 :class="key !== 'Commission Rate :'? 'hide_rate_tip' : ''"
                                 v-for="value in item">
                                <span class='hello'
                                      v-if="getValueShow(key)">
                                    {{value}}
                                </span>
                                <div class="skip_route"
                                     v-if="getRouteShow(key)">
                                    <router-link v-if="key === 'Input Address :' && value !== '-'"
                                                 :to="addressRoute(value)">{{value}}
                                    </router-link>
                                    <router-link v-if="key === 'Author :' && value !== '-'"
                                                 :to="addressRoute(value)">{{value}}
                                    </router-link>
                                    ...
                                    <router-link v-if="key === 'Symbol :' && value !== '-'"
                                                 :to="`asset/${value}`">{{value}}
                                    </router-link>
                                    <router-link v-if="key === 'DestAddress :' && value !== '-'"
                                                 :to="addressRoute(value)">{{value}}
                                    </router-link>
                                    ...
                                    <router-link v-if="key === 'Operator Address :'"
                                                 :to="addressRoute(value)">{{value}}
                                    </router-link>
                                    <router-link v-if="key === 'Owner Address :'"
                                                 :to="addressRoute(value)">{{value}}
                                    </router-link>
                                    <router-link v-if="key === 'Delegator Address :'"
                                                 :to="addressRoute(value)">{{value}}
                                    </router-link>
                                    ...
                                    <router-link v-if="key === 'Proposal ID :'"
                                                 :to="`ProposalsDetail/${value}`">{{value}}
                                    </router-link>
                                    <router-link v-if="key === 'Voter :'" :to="addressRoute(value)">{{value}}
                                    </router-link>
                                    <router-link v-if="key === 'Original Owner :'"
                                                 :to="addressRoute(value)">{{value}}
                                    </router-link>
                                    <router-link v-if="key === 'New Owner :'"
                                                 :to="addressRoute(value)">{{value}}
                                    </router-link>
                                    <router-link v-if="key === 'Address :'"
                                                 :to="addressRoute(value)">{{value}}
                                    </router-link>
                                    <router-link v-if="key === 'Added By :'"
                                                 :to="addressRoute(value)">{{value}}
                                    </router-link>
                                    <router-link v-if="key === 'Deleted By :'"
                                                 :to="addressRoute(value)">{{value}}
                                    </router-link>
                                    <router-link
                                            v-if="key === 'Hash Lock :' && messageList['TxType :'][0] !== 'CreateHTLC'"
                                            :to="`/htlc/${value}`">{{value}}
                                    </router-link>
                                    <router-link
                                            v-if="key === 'Hash Lock :' && messageList['TxType :'][0] === 'CreateHTLC' && statusValue === 'Success'"
                                            :to="`/htlc/${value}`">{{value}}
                                    </router-link>
                                    <span v-if="key === 'Hash Lock :' && statusValue === 'Failed' && messageList['TxType :'][0] === 'CreateHTLC'">{{value}}</span>
                                    <span v-if="key === 'Website :' && value !== '--'" @click="openUrl(value)"
                                          style="color: var(--bgColor);cursor: pointer;">{{value}}</span>
                                    <span v-if="key === 'Software :'&& value !== '--'" @click="openUrl(value)"
                                          style="color: var(--bgColor);cursor: pointer;">{{value}}</span>
                                    <span v-if="key === 'Identity :'&& value !== '--'" @click="getKeyBaseName(value)"
                                          style="color: var(--bgColor);cursor: pointer;">{{value}}</span>
                                ...
                                <div class="commission_rate_container"
                                    ...
                                    <i class="iconfont icontishi"></i>
                                    <div class="commission_rate_content_wrap"
                                         :style="{left:`${-((rateContentWidth / 2) - 7) / 100}rem`}">
