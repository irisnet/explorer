          ...
          if(data && typeof  data === "object" ){
            ...
            if(data.proposal.proposal_id === 0){
              ...
              if(data.proposal && data.proposal.total_deposit.length !==0){
                this.totalDeposit = `${Tools.scientificNotationConversionNumber(Tools.formatNumber(data.proposal.total_deposit[0].amount))} ${Tools.formatDenom(data.proposal.total_deposit[0].denom).toUpperCase()}`;
              }else {
                this.totalDeposit = "";
              }
