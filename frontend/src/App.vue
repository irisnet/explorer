<template>
  <div id="app"
       @click.stop="closeSelectOption">
    <app-header v-show="flShowHeader"></app-header>
    <div id="router_wrap"
         :style="{'padding-top': $store.state.isMobile ? '' :`${headerHeightStyle}`}">
      <div class="qr_code"
           @click="hideQRCode"
           :style="`width:${vw}px;height:${vh}px`"
           v-show="weChatQRShow">
        <div class="qr_mask">
          <img src="./assets/wechat_qr.png"
      ...
      <div class="qr_code"
           ...
           v-show="qqQRShow">
        <div class="qr_mask">
          <img src="./assets/qq_qr.png"
               style="width:1.8rem;height:1.8rem;">
          <h2>Join QQ group</h2>
        </div>
      </div>
      <router-view class="router_view"
                   :style="`min-height:${vh/100-2.72}rem;`"
                   :key="key" />
        ...
        <div :class="footerClassName"
          ...
          <div class="footer_left"
            ...
            <a target="_blank"
               ...
               class="facebook"></a>
            <span class="we_chat"
                  @click="showQRCode"></span>
            <span class="qq"
                  @click="showqqQRCode"></span>
          </div>
          ...
          <div class="footer_right"
               :class="footerRightVar">
            <div class="footer_link_wrap">
              <a href="https://www.irisnetwork.cn/testnets"
                 target="_blank">
